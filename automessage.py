...
text = """
        ...
        Напиши <a href="tg://user?id=508169464">создателю</a> или <a href="tg://user?id=1564155100">соучредителю</a>, что бы тебе подсказали, что надо сделать, что бы вернуться в чат.
